package com.innovation.spring.resource.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("resourceServer");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("resourceServer");
        ...
        config.getMapConfigs().put("com.innovation.spring.resource.domain.*", initializeDomainMapConfig(jHipsterProperties));
